    ...
    Factory.prototype = {
        ...
        init: function () {
            try {
                ...
                this._canvas.style['background-color'] = 'linear-gradient(-180deg, #BCC5CE 0%, #929EAD 98%), radial-gradient(at top left, rgba(255,255,255,0.30) 0%, rgba(0,0,0,0.30) 100%); background-blend-mode: screen';
